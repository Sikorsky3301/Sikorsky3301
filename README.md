...
[![My Skills](https://skillicons.dev/icons?i=aws,azure,gcp,docker,kubernetes,python,react,flutter,tensorflow,cpp,javascript,typescript,nodejs,go,dart,fastapi,java,bash,github,linux,pytorch,opencv,git,kali,mongodb,mysql&perline=14)](https://skillicons.dev)
