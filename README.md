...
[![My Skills](https://skillicons.dev/icons?i=aws,azure,gcp,flask,docker,kubernetes,python,git,react,flutter,androidstudio,cpp,javascript,typescript,nodejs,go,fastapi,java,bash,pytorch,git,kali,mongodb,mysql&perline=12)](https://skillicons.dev)
