...
[![My Skills](https://skillicons.dev/icons?i=aws,azure,gcp,flask,docker,kubernetes,python,git,react,flutter,tensorflow,cpp,javascript,typescript,nodejs,go,dart,fastapi,java,bash,pytorch,opencv,git,kali,mongodb,mysql&perline=13)](https://skillicons.dev)
